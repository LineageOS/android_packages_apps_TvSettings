...
public class FullScreenDialogFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    } else if (getDrawableIcon() != null) {
      iconView.setVisibility(View.VISIBLE);
      iconView.setImageDrawable(getDrawableIcon());
    }
    ...
    positiveButton.setVisibility(TextUtils.isEmpty(positiveButtonLabel) ? View.GONE : View.VISIBLE);
    ...
    negativeButton.setVisibility(TextUtils.isEmpty(negativeButtonLabel) ? View.GONE : View.VISIBLE);
  ...
  /** Set the icon if the argument is not present. Needed because Drawables are not parcelable */
