...
public interface ListBuilder {
   ...
   *
   * <p>The header should contain a title that is representative of the content in this slice along
   * with an intent that links to the app activity associated with this content.
   */
  void setHeader(@NonNull HeaderBuilder impl);

  /**
   * Adds an action to this template. Actions added with this method are grouped together and may be
   * shown on the template in large or small formats.
   */
  ...
  /**
   * If all content in a slice cannot be shown, a "see more" affordance will be displayed where the
  ...
  /**
   * Sets the time-to-live for this slice, i.e. how long the data contained in the slice can remain
   * fresh.
   *
