...
public class SliceHints {
  ...
  /**
   * Subtype to tag an item as representing a time in milliseconds since midnight, January 1, 1970
   * UTC.
   */
  ...
  /**
   * Hint indicating that this slice represents an option selectable in a selection slice. The
   * parent of this slice must be of subtype {@link #SUBTYPE_SELECTION}.
   */
   ...
   * user selects this option. The parent of this slice must have hint {@link
   * #HINT_SELECTION_OPTION}.
   *
   * <p>Expected to be an item of format {@link
   * com.android.tv.twopanelsettings.slices.compat.SliceItem@FORMAT_TEXT}.
   */
