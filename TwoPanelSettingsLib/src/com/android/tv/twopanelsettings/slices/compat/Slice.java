...
import static com.android.tv.twopanelsettings.slices.compat.core.SliceHints.HINT_ACTIVITY;
import static com.android.tv.twopanelsettings.slices.compat.core.SliceHints.HINT_CACHED;
import static com.android.tv.twopanelsettings.slices.compat.core.SliceHints.HINT_END_OF_SECTION;
import static com.android.tv.twopanelsettings.slices.compat.core.SliceHints.HINT_OVERLAY;
import static com.android.tv.twopanelsettings.slices.compat.core.SliceHints.HINT_RAW;
...
/**
 * A slice is a piece of app content and actions that can be surfaced outside of the app. A slice is
 * identified by a Uri and served via a {@link SliceProvider}.
 *
 * <p>Slices are constructed using {@link
 * com.android.tv.twopanelsettings.slices.compat.builders.TemplateSliceBuilder}s in a tree structure
...
public final class Slice extends CustomVersionedParcelable implements VersionedParcelable {
  ...
  /**
   * Subtype to tag an item as representing the progress bar mode for a {@link
   * android.app.slice.Slice#SUBTYPE_RANGE}
   */
  ...
  public static class Builder {
    ...
    /**
     * Create a builder for a {@link Slice} that is a sub-slice of the slice being constructed by
    ...
    private Uri getChildUri() {
      return mUri.buildUpon().appendPath("_gen").appendPath(String.valueOf(mChildId++)).build();
    }
    ...
    public @NonNull Builder addAction(
        @NonNull Parcelable action, @NonNull Slice s, @Nullable String subType) {
     ...
     */
    public @NonNull Builder addAction(
        @NonNull Slice s, @Nullable String subType, @NonNull SliceItem.ActionHandler action) {
      Preconditions.checkNotNull(s);
      @SliceHint String[] hints = s.getHintArray();
      mItems.add(new SliceItem(action, s, FORMAT_ACTION, subType, hints));
      return this;
     ...
     * @see SliceItem#getSubType()
     */
    public @NonNull Builder addText(
     ...
     * @see SliceItem#getSubType()
     */
    public @NonNull Builder addIcon(
        @NonNull IconCompat icon, @Nullable String subType, @NonNull @SliceHint String... hints) {
     ...
     */
    // @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP_PREFIX)
    public @NonNull Builder addRemoteInput(
     ...
     * @see SliceItem#getSubType()
     */
    public @NonNull Builder addInt(
        int value, @Nullable String subType, @NonNull @SliceHint String... hints) {
     ...
     */
    public @NonNull Builder addInt(
        int value, @Nullable String subType, @NonNull @SliceHint List<String> hints) {
     ...
     * @see SliceItem#getSubType()
     */
    public @NonNull Builder addLong(
        long time, @Nullable String subType, @NonNull @SliceHint String... hints) {
     ...
     */
    public @NonNull Builder addLong(
        long time, @Nullable String subType, @NonNull @SliceHint List<String> hints) {
     ...
     *
     * @param subType Optional template-specific type information
     * @see SliceItem#getSubType() TO BE REMOVED
     */
    // @Deprecated // Supported for TV
     ...
     * @see SliceItem#getSubType()
     */
    public @NonNull Builder addTimestamp(
        long time, @Nullable String subType, @NonNull @SliceHint List<String> hints) {
