...
public class SliceItemHolder implements VersionedParcelable {
  ...
  @Nullable public static HolderHandler sHandler;
  ...
  @NonParcelField Object mCallback;
  ...
  @Nullable @NonParcelField private SliceItemPool mPool;
  ...
  public SliceItemHolder(@NonNull String format, Object mObj, boolean isStream) {
    switch (format) {
      ...
      case FORMAT_TEXT:
        mStr =
            mObj instanceof Spanned
                ? HtmlCompat.toHtml((Spanned) mObj, HtmlCompat.TO_HTML_PARAGRAPH_LINES_CONSECUTIVE)
                : (String) mObj;
        break;
      case FORMAT_INT:
        mInt = (Integer) mObj;
  ...
  public Object getObj(@NonNull String format) {
    ...
    switch (format) {
      case FORMAT_ACTION:
        ...
        if (intent == null && mParcelable == null && mVersionedParcelable == null) {
          return null;
        }
        return new Pair<>(
            intent != null ? intent : mParcelable != null ? mParcelable : mCallback,
