 ...
 *
 * <p>A SliceItem a piece of content and some hints about what that content means or how it should
 * be displayed. The types of content can be:
 *
 * <ul>
 *   <li>{@link android.app.slice.SliceItem#FORMAT_SLICE}
 *   <li>{@link android.app.slice.SliceItem#FORMAT_TEXT}
 *   <li>{@link android.app.slice.SliceItem#FORMAT_IMAGE}
 *   <li>{@link android.app.slice.SliceItem#FORMAT_ACTION}
 *   <li>{@link android.app.slice.SliceItem#FORMAT_INT}
 *   <li>{@link android.app.slice.SliceItem#FORMAT_LONG}
 * </ul>
 *
 * <p>The hints that a {@link SliceItem} are a set of strings which annotate the content. The hints
 * that are guaranteed to be understood by the system are defined on {@link Slice}.
 *
...
public final class SliceItem {
  ...
  public SliceItem(
      Object obj,
      @NonNull @SliceType String format,
   ...
   *
   * <p>The format will be one of the following types supported by the platform:
   *
   * <ul>
   *   <li>{@link android.app.slice.SliceItem#FORMAT_SLICE}
   *   <li>{@link android.app.slice.SliceItem#FORMAT_TEXT}
   ...
   *   <li>{@link android.app.slice.SliceItem#FORMAT_INT}
   *   <li>{@link android.app.slice.SliceItem#FORMAT_LONG}
   *   <li>{@link android.app.slice.SliceItem#FORMAT_REMOTE_INPUT}
   * </ul>
   *
   * @see #getSubType() ()
   */
   ...
   *
   * <p>Subtypes provide additional information about the type of this information beyond basic
   * interpretations inferred by {@link #getFormat()}. For example a slice may contain many {@link
   * android.app.slice.SliceItem#FORMAT_TEXT} items, but only some of them may be {@link
   * android.app.slice.Slice#SUBTYPE_MESSAGE}.
   *
   * @see #getFormat()
   */
  @Nullable
  ...
  public CharSequence getSanitizedText() {
    if (mSanitizedText == null) {
      mSanitizedText = sanitizeText(getText());
    }
  ...
  /**
   * @return The slice held by this {@link android.app.slice.SliceItem#FORMAT_ACTION} or {@link
   *     android.app.slice.SliceItem#FORMAT_SLICE} SliceItem
   */
  @Nullable
  @SuppressWarnings("unchecked")
  ...
  /**
   * @return The long held by this {@link android.app.slice.SliceItem#FORMAT_LONG} SliceItem
   */
  public long getLong() {
    ...
    switch (getFormat()) {
      ...
      case FORMAT_INT:
        if (android.app.slice.Slice.SUBTYPE_COLOR.equals(getSubType())) {
          ...
          sb.append(
              String.format(
                  "a=0x%02x r=0x%02x g=0x%02x b=0x%02x",
  ...
  private static CharSequence redactSensitiveText(CharSequence text) {
    if (text instanceof Spannable) {
      ...
      if (!isRedactionNeeded((Spanned) text)) {
        return text;
      }
  ...
  private static boolean isRedactionNeeded(@NonNull Spanned text) {
    for (Annotation span : text.getSpans(0, text.length(), Annotation.class)) {
      if (SLICE_CONTENT.equals(span.getKey()) && SLICE_CONTENT_SENSITIVE.equals(span.getValue())) {
        return true;
      }
    }
    return false;
  ...
  private static CharSequence sanitizeText(@Nullable CharSequence text) {
    if (text instanceof Spannable) {
      ...
      if (checkSpannedText((Spanned) text)) {
        return text;
      }
      Spannable fixedText = new SpannableString(text);
