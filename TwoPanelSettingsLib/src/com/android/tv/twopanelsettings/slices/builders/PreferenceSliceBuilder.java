...
public class PreferenceSliceBuilder extends TemplateSliceBuilder {
   ...
   */
  public PreferenceSliceBuilder(
      @NonNull Context context, @NonNull Uri uri, @Nullable Duration ttl) {
    super(context, uri);
    mImpl.setTtl(ttl);
  }
  ...
  /**
   * Add a preference builder. If the row is expected to be actionable, it is recommended to invoke
   * setActionId() for the RowBuilder to help with logging.
   */
  ...
  public static class RowBuilder {
    ...
    /**
     * Sets the icon for the preference builder. There can only be one icon, this will replace any
     * other icon that may have been set. This means that you should only provide an icon using one
     * of the two functions {@link #setIcon(IconCompat)} or {@link #setEndIcon(IconCompat)}.
     *
     * @param icon the image to display.
     */
    @NonNull
    ...
    /**
     * Sets the icon to the end for the preference builder. There can only be one icon, this will
     * replace any other icon that may have been set. This means that you should only provide an
     * icon using one of the two functions {@link #setIcon(IconCompat)} or {@link
     * #setEndIcon(IconCompat)}.
     *
     * @param icon the image to display.
     */
    @NonNull
    ...
    /**
     * Set the information image for the preference builder. The image would be displayed at the top
     * of preview screen.
     */
    @NonNull
    @CanIgnoreReturnValue
    ...
    /**
     * Set the information title icon for the preference builder. The icon will be displayed to the
     * left of description text title
     */
    @NonNull
    @CanIgnoreReturnValue
     ...
     *
     * <p>It is strongly recommended to also invoke setContentDescription() for a11y purposes.
     * Please see setContentDescription() for more details.
     */
    @NonNull
    @CanIgnoreReturnValue
    ...
    /**
     * Set a followup pendingIntent for the preference builder. After the initial pendingIntent is
     * launched and result is retrieved by TvSettings, TvSettings will pack the result into the
     * followup PendingIntent and launch it.
     *
    ...
    /**
     * Set the action ID for the row builder. If this is invoked for building an actionable row, it
     * will be digested as actionId for logging purpose when the action is triggered.
     *
    ...
    /**
     * Set the page ID for the row builder. If this is invoked for building the screen title row, it
     * will be digested as pageId for logging purpose when the SliceFragment is focused.
     *
     ...
     *
     * <p>Although TvSettings will try to construct the content description to its best extent if
     * it's not set, it is strongly recommended to invoke this method with info items folded in the
     * content description for the Roy for a11y purposes, as the info items may be unfocusable when
     * talkback is on.
     *
     * <p>By default, this method will assign the full info item title and summary to the content
     * description if one is not specified.
     */
    @NonNull
    @CanIgnoreReturnValue
