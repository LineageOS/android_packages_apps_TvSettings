...
public class PreferenceSliceBuilderImpl extends TemplateBuilderImpl {
  ...
  /**
   * Set the embedded preference. This preference would be embedded in other TvSettings preference
   * items.
   */
  ...
  public static class RowBuilderImpl extends TemplateBuilderImpl {
    ...
    private void setTitleItem(IconCompat icon, int imageMode, boolean isLoading) {
      ...
      Slice.Builder sb = new Slice.Builder(getBuilder()).addIcon(icon, null /* subType */, hints);
      if (isLoading) {
    ...
    public void setHasEndIcon(boolean hasEndIcon) {
      mHasEndIconItem =
          new SliceItem(hasEndIcon ? 1 : 0, FORMAT_INT, EXTRA_HAS_END_ICON, new String[] {});
    }

    /** */
    public void setButtonStyle(@BUTTONSTYLE int buttonStyle) {
      mButtonStyleItem =
          new SliceItem(buttonStyle, FORMAT_INT, SUBTYPE_BUTTON_STYLE, new String[] {});
    }

    /** Set minimum value of the seekbar. */
    public void setSeekbarMin(int value) {
      mSeekbarMinItem = new SliceItem(value, FORMAT_INT, SUBTYPE_SEEKBAR_MIN, new String[] {});
    }

    /** Set maximum value of the seekbar. */
    public void setSeekbarMax(int value) {
      mSeekbarMaxItem = new SliceItem(value, FORMAT_INT, SUBTYPE_SEEKBAR_MAX, new String[] {});
    }

    /** Set progress value of the seekbar. */
    public void setSeekbarValue(int value) {
      mSeekbarValueItem = new SliceItem(value, FORMAT_INT, SUBTYPE_SEEKBAR_VALUE, new String[] {});
    }

    /** */
    public void setRadioGroup(CharSequence radioGroup) {
      mRadioGroupItem = new SliceItem(radioGroup, FORMAT_TEXT, TAG_RADIO_GROUP, new String[] {});
    }

    /** */
    public void setEnabled(boolean enabled) {
      mIsEnabledItem =
          new SliceItem(enabled ? 1 : 0, FORMAT_INT, SUBTYPE_IS_ENABLED, new String[] {});
    }

    public void setSelectable(boolean selectable) {
      mIsSelectableItem =
          new SliceItem(selectable ? 1 : 0, FORMAT_INT, SUBTYPE_IS_SELECTABLE, new String[] {});
    }

    public void setAddInfoStatus(boolean addInfoStatus) {
      mIsAddingInfoStatusItem =
          new SliceItem(addInfoStatus ? 1 : 0, FORMAT_INT, EXTRA_ADD_INFO_STATUS, new String[] {});
    }
    ...
    public void setInfoImage(IconCompat infoImage) {
      mInfoImageItem =
          new SliceItem(infoImage, FORMAT_IMAGE, EXTRA_PREFERENCE_INFO_IMAGE, new String[] {});
    }

    public void setInfoTitleIcon(IconCompat infoImage) {
      mInfoTitleIconItem =
          new SliceItem(infoImage, FORMAT_IMAGE, EXTRA_PREFERENCE_INFO_TITLE_ICON, new String[] {});
    }

    public void setInfoTitle(CharSequence infoTitle) {
      mInfoTextItem =
          new SliceItem(infoTitle, FORMAT_TEXT, EXTRA_PREFERENCE_INFO_TEXT, new String[] {});
    }

    public void setInfoSummary(CharSequence infoSummary) {
      mInfoSummaryItem =
          new SliceItem(infoSummary, FORMAT_TEXT, EXTRA_PREFERENCE_INFO_SUMMARY, new String[] {});
    }
