...
public class DevelopmentFragment extends SettingsPreferenceFragment
    ...
    public void onEnableAdbConfirm() {
        if (getResources().getBoolean(R.bool.has_convertible_port)) {
            ...
            intent.setComponent(new ComponentName(getContext().getPackageName(), ShieldMtpActivity.class));
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mEnableDeveloper) {
            ...
            Intent intent = new Intent();
            intent.setComponent(new ComponentName(SETTINGS_PKG, ShieldMtpActivity.class));
            intent.putExtra(ShieldMtpActivity.CALLER, true);
