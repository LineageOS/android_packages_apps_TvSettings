...
public class DevelopmentFragment extends SettingsPreferenceFragment
    ...
    private AdbNetworkManager mAdbNetworkManager;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAdbNetworkManager = AdbNetworkManager.getInstance(getContext());
    ...
    private void updateAdbOverNetwork() {
        boolean enabled = mAdbNetworkManager.getEnabled();
        updateSwitchPreference(mAdbOverNetwork, enabled);

        if (enabled) {
            mAdbOverNetwork.setSummary(mAdbNetworkManager.getHostAddress() +
                    ":" + AdbNetworkManager.ADB_NETWORK_PORT);
        } else {
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mEnableDeveloper) {
            ...
            mAdbNetworkManager.setEnabled(mAdbOverNetwork.isChecked());
            updateAdbOverNetwork();
