...
/** State for displaying that sharing the Thread network timed out. */
class TimeoutState(private val activity: FragmentActivity) : State {
    ...
    /** Fragment displaying that sharing the Thread network timed out. */
    class TimeoutFragment : WifiConnectivityGuidedStepFragment() {
        private lateinit var stateMachine: StateMachine

        override fun onCreateGuidance(savedInstanceState: Bundle?): GuidanceStylist.Guidance {
            return GuidanceStylist.Guidance(
                getString(R.string.thread_network_sharing_timeout),
                null,
                null,
                null
            )
