...
/**
 * State for handling the case when the connection is timed out.
 */
public class ConnectTimeOutState implements State {
    private final FragmentActivity mActivity;
    private Fragment mFragment;

    public ConnectTimeOutState(FragmentActivity activity) {
        mActivity = activity;
    }
    ...
    public void processForward() {
        ...
        UserChoiceInfo userInfo = ViewModelProviders.of(mActivity)
                .get(UserChoiceInfo.class);
        advInfo.setCanStart(true);
        advInfo.setPrintableSsid(userInfo.getWifiConfiguration().getPrintableSsid());
        mFragment = new ConnectTimeOutFragment();
    ...
    /**
     * Notifies the user the connection is timed out.
     */
    public static class ConnectTimeOutFragment extends WifiConnectivityGuidedStepFragment {
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            String title = getString(
                    R.string.title_wifi_could_not_connect_timeout,
