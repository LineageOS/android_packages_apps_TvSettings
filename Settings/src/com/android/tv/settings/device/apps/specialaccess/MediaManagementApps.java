...
/**
 * Settings screen for managing "Media management apps" permission
 */
@Keep
public class MediaManagementApps extends ManageAppOp {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            mPackageName = bundle.getString(Intent.EXTRA_PACKAGE_NAME);
        }
    }

    @Override
    public int getAppOpsOpCode() {
        return AppOpsManager.OP_MANAGE_MEDIA;
    }

    @Override
    public String getPermission() {
        return Manifest.permission.MANAGE_MEDIA;
    }
