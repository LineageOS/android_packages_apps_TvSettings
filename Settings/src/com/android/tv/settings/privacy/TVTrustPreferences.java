...
public class TVTrustPreferences extends SettingsPreferenceFragment {
    ...
    private void setupSELinux(int level) {
        ...
        if (level == TrustInterface.TRUST_FEATURE_LEVEL_GOOD) {
            icon = org.lineageos.lineageparts.R.drawable.ic_trust_selinux_good;
            summary = R.string.trust_feature_selinux_value_enforcing;
        } else {
            icon = org.lineageos.lineageparts.R.drawable.ic_trust_selinux_bad;
        ...
        if (vendor == TrustInterface.ERROR_UNDEFINED) {
            switch (platform) {
                case TrustInterface.TRUST_FEATURE_LEVEL_GOOD:
                    icon = org.lineageos.lineageparts.R.drawable.ic_trust_security_patches_good;
                    break;
                case TrustInterface.TRUST_FEATURE_LEVEL_POOR:
                    icon = org.lineageos.lineageparts.R.drawable.ic_trust_security_patches_poor;
                    break;
                default:
                    icon = org.lineageos.lineageparts.R.drawable.ic_trust_security_patches_bad;
                    break;
            }
        } else {
    ...
    private void setupEncryption(int level) {
        ...
        if (level == TrustInterface.TRUST_FEATURE_LEVEL_GOOD) {
            icon = org.lineageos.lineageparts.R.drawable.ic_trust_encryption_good;
            summary = R.string.trust_feature_encryption_value_enabled;
        } else if (level == TrustInterface.TRUST_FEATURE_LEVEL_POOR) {
            icon = org.lineageos.lineageparts.R.drawable.ic_trust_encryption_poor;
            summary = R.string.trust_feature_encryption_value_nolock;
        } else {
            icon = isLegacy ?
                org.lineageos.lineageparts.R.drawable.ic_trust_encryption_poor :
                org.lineageos.lineageparts.R.drawable.ic_trust_encryption_bad;
    ...
    public int getMetricsCategory() {
        return LineageMetricsLogger.PRIVACY_SETTINGS;
    }
}